(function () {
  ...
  const DEFINITIONS = {
    'anqin-teacher': {
      ...
      path: 'review/anqin-v2/index.html?v=20260901-identity-evidence-repair-2',
    },
    'anqin-manager': {
      id: 'anqin-manager',
      group: 'anqin',
    ...
    'admin-marketing': {
      ...
      icon: 'megaphone',
      path: 'review/admin-marketing-v1/index.html?workspace=admin-marketing&v=20260901-admin-future-trial-1',
    },
    'admin-marketing-manager': {
      ...
      icon: 'clipboard-list',
      path: 'review/admin-marketing-v1/index.html?workspace=admin-marketing-manager&v=20260901-admin-future-trial-1',
    },
  };
