(function () {
  ...
  const DEFINITIONS = {
    'anqin-teacher': {
      ...
      path: 'review/anqin-v2/index.html?v=20260901-required-materials-admin-ux-1',
    },
    'anqin-manager': {
      id: 'anqin-manager',
      group: 'anqin',
    ...
    'talent-fulltime': {
      ...
      icon: 'sparkles',
      path: 'review/talent-v2/index.html?workspace=talent-fulltime&v=20260901-required-materials-admin-ux-1',
    },
    'talent-pt': {
      id: 'talent-pt',
      group: 'talent',
      ...
      icon: 'clock-3',
      path: 'review/talent-v2/index.html?workspace=talent-pt&v=20260901-required-materials-admin-ux-1',
    },
    'talent-manager': {
      id: 'talent-manager',
      group: 'talent',
      ...
      path: 'review/talent-v2/index.html?workspace=talent-manager&v=20260901-required-materials-admin-ux-1',
    },
    'talent-payroll': {
      id: 'talent-payroll',
      group: 'talent',
      ...
      icon: 'calculator',
      path: 'review/talent-v2/index.html?workspace=talent-payroll&v=20260901-required-materials-admin-ux-1',
    },
    'admin-marketing': {
      id: 'admin-marketing',
      ...
      icon: 'megaphone',
      path: 'review/admin-marketing-v1/index.html?workspace=admin-marketing&v=20260901-required-materials-admin-ux-1',
    },
    'admin-marketing-manager': {
      ...
      icon: 'clipboard-list',
      path: 'review/admin-marketing-v1/index.html?workspace=admin-marketing-manager&v=20260901-required-materials-admin-ux-1',
    },
  };
  ...
  function switchTo(id, user = {}) {
    ...
    if (isReviewPreview && !window.AUTH?.getSession?.()) {
  ...
  document.addEventListener('click', event => {
    ...
    if (option) {
      const session = window.AUTH?.getSession?.() || window.KPI_REVIEW_USER || {};
