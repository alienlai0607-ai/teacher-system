(function () {
  ...
  const DEFINITIONS = {
    ...
    'admin-marketing': {
      ...
      icon: 'megaphone',
      path: 'review/admin-marketing-v1/index.html?workspace=admin-marketing&v=20260901-prep-delete-confirm-1',
    },
    'admin-marketing-manager': {
      ...
      icon: 'clipboard-list',
      path: 'review/admin-marketing-v1/index.html?workspace=admin-marketing-manager&v=20260901-prep-delete-confirm-1',
    },
  };
