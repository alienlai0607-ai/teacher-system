...
assert.match(uiHtmlSource, /styles\.css\?v=20260912-campus-switch-1/, '班級人數版面需使用獨立快取版本');
assert.match(uiHtmlSource, /app\.js\?v=20260912-campus-switch-1/, '班級人數互動需使用獨立快取版本');
assert.match(uiHtmlSource, /shared\/api\.js\?v=20260912-campus-switch-1/, '行政頁需載入班級人數 API 版本');
...
assert.equal((workspacesSource.match(/admin-marketing-v1\/index\.html\?workspace=(?:admin-marketing|admin-marketing-manager|class-roster-manager)&v=20260912-campus-switch-1/g) || []).length, 3, '行政、主管與班級人數入口都需避開舊版快取');
