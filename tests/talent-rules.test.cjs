...
assert.match(talentUiSource, /並至少附上一份教案、教材、照片或備課影片/, '才藝使用說明必須與附件必填規則一致');
...
assert.match(talentUiSource, /單檔上限 25 MB/, '所有才藝備課附件的上傳限制需在選檔前說清楚');
...
assert.match(talentIndexSource, /app\.js\?v=20260912-own-roster-1/, '才藝頁需更新程式快取版本，避免登入後仍讀到舊介面');
